...
export const AnalyticsDrawer: React.FC = () => {
  ...
  return (
    <div className="w-105 bg-navy-950/95 backdrop-blur-lg border-l border-navy-800 h-full flex flex-col font-mono text-xs select-none shadow-2xl text-gray-200">
      {/* Header */}
